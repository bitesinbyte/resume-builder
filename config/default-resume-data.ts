...
export const DefaultResumeData: Resume = {
  ...
  summary:
    "Innovative Software Engineer with 8 years of experience in building scalable web applications and optimizing user experiences. Passionate about solving complex problems and enhancing product performance using modern technologies.",
  education: [
    {
  ...
  skills: [
    ...
    },
    {
      ...
      skills: ["Technical Writing", "Agile Methodologies", "Public Speaking"],
    },
  ],
