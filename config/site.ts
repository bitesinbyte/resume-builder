...
export const siteConfig = {
    homepage: "https://resume.bitesinbyte.com",
    logo: "https://resume.bitesinbyte.com/assets/android-chrome-512x512.png",
    name: "Resume Builder | Get hired with an ATS-optimized resume",
